package com.RESTService.Template.RESTControllers.PUTMappings.Template;
...
@RestController(value = "PUT*NAME*Controller")
class Controller {
    ...
    @PutMapping(value = "/uriPath")
    // TODO: specify function name and paramName
    public ResponseEntity<String> put(@RequestParam(value = "paramName") String paramName) {
